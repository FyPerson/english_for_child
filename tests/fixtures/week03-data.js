/* Derived snapshot; author frontend/src/weeks/weekNN.data.js instead. */

const META = {
  "week": 3,
  "storageKey": "soundblocks-w3-v1",
  "rackG4": ["a","o","u","h","m","d","g","l","f","b"],
  "rackG5": ["s","a","t","i","p","n","c","k","e","h","r","m","d","g","o","u","l","f","b"],
  /* 墙语义统一（方案 §2.4），与 frontend/src/weeks/week03.data.js 同步：wallLetters
   * 恒为墙上完整的积木集合、按累计教学顺序排列，本周新点亮的由 newPatterns 表达。 */
  "wallLetters": ["s","a","t","i","p","n","c","k","e","h","r","m","d","g","o","u","l","f","b"],
  "newPatterns": ["g","o","u","l","f","b"],
  "groupedRack": true,
  "consolidation": false,
...
const RESERVED = ['gut','bud','fin','lob','fib'];   /* 周检五词，全 CVC，本周任何练习/游戏/小书里都不出现 */
...
const SOUNDS = {
  ...
  c:{grapheme:'c', ipa:'/k/', type:'c', art:'camera', mem:'咔嚓相机 k-k-k', audioKey:'c',
  ...
  e:{grapheme:'e', ipa:'/e/', type:'v', art:'huh', mem:'没听清，反问一声 e?',
  ...
  h:{grapheme:'h', ipa:'/h/', type:'c', art:'breath', mem:'对手心轻轻哈气 hhh',
  ...
  r:{grapheme:'r', ipa:'/r/', type:'c', art:'racecar', mem:'小赛车启动 rrr',
  ...
  m:{grapheme:'m', ipa:'/m/', type:'c', art:'yum', mem:'闭嘴尝美味 mmmmm',
  ...
  d:{grapheme:'d', ipa:'/d/', type:'c', art:'drum', mem:'小鼓轻敲 d-d-d',
  ...
  /* ---- 第三周六个新音 ---- */
  g:{grapheme:'g', ipa:'/g/', type:'c', art:'gulp', mem:'咕咚咕咚大口喝水 g-g-g',
  ...
  o:{grapheme:'o', ipa:'/ɑ/', type:'v', art:'doctor', mem:'看医生张大嘴 o-o-o',
  ...
  u:{grapheme:'u', ipa:'/ʌ/', type:'v', art:'umbrella', mem:'伞打不开急得直哼 u-u-u',
  ...
  l:{grapheme:'l', ipa:'/l/', type:'c', art:'lollipop', mem:'舔棒棒糖 llllll',
  ...
  f:{grapheme:'f', ipa:'/f/', type:'c', art:'candle', mem:'轻轻吹蜡烛 fffff',
  ...
  b:{grapheme:'b', ipa:'/b/', type:'c', art:'ball', mem:'皮球弹起来 b-b-b',
...
SOUNDS.k = Object.assign({}, SOUNDS.c, { grapheme:'k' });
...
const W = {
  ...
  pin:{zh:'大头针',art:'pin'}, pan:{zh:'平底锅',art:null}, nap:{zh:'打个盹',art:null}, tap:{zh:'水龙头',art:null},
  ...
  got:{zh:'拿到了',art:'got'}, dot:{zh:'点',art:null},      not:{zh:'不',art:'not'},     hut:{zh:'小屋',art:'hut'},   cut:{zh:'切',art:'cut'},
  hog:{zh:'肥猪',art:'hog'},   mug:{zh:'马克杯',art:'mug'}, rug:{zh:'地毯',art:'rug'},   dug:{zh:'挖了',art:'dug'},   rag:{zh:'抹布',art:null},
  tag:{zh:'标签',art:null},    lot:{zh:'很多',art:null},    fed:{zh:'喂了',art:null},    gum:{zh:'口香糖',art:'gum'}, bun:{zh:'小圆面包',art:null},
...
const G1_THEME = {
  g: { title:'轮 A · 抓住 /g/', icon:'gulp', cmd:'开头听到 g 就拍气球' },
  u: { title:'轮 B · 抓住 /ʌ/', icon:'umbrella', cmd:'听到词的肚子里藏着 /ʌ/ 就拍气球' }
};
...
const DAYS = [
{
  ...
  steps:[
    ...
    {t:'听音找首字母', min:6, blocks:[
      {b:'lead', html:'电脑随机念一个词，孩子自己点击 <span class="en">g</span> 或 <span class="en">c</span>。答错不会换题，可以反复听、再点一次——<b>先靠耳朵分辨，不看单词提示</b>。'},
      {b:'initialpick', words:['gap','cap','get','cat','can'], letters:['g','c']}
    ]},
    {t:'收尾打卡', min:4, blocks:[
      {b:'checks', items:[
